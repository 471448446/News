...
package com.better.news.db.table;
...
public class ReadingTable {
    ...
    public static final int ID_BOOK_PAGE =7;
    public static final int ID_BOOK_PUB =8;
    public static final int ID_BOOK_AUTH =9;
    public static final int ID_CATEGORY =10;
    public static final int ID_IS_COLLECTED =11;
