 ...
 */
public abstract class SimpleNoLoadMoreRefreshFragment extends BaseListFragment {
    @Override
    protected View initRootView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_simplenoloadmorrefresh, container, false);
    }
